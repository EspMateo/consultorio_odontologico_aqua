...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173","https://consultorio-odontologico-aqua.vercel.app", "https://github.com/EspMateo/consultorio_odontologico_aqua.git"));
